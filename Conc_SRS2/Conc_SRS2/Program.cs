...
namespace Conc_SRS2
{
	...
	class Program
    {
        ...
        {
			PLinqSample pLinqSample = new PLinqSample();
			pLinqSample.Simple_parallel_prime();
			pLinqSample.As_parallel_out_of_sequence();
			pLinqSample.Spellchecker_example();
			pLinqSample.Parallel_side_effect();
			pLinqSample.Cancel_with_token();
			pLinqSample.NJustice_for_all();
			pLinqSample.Range_partitioning_is_slower_for_primes();
		}
    }
