...
namespace Combinators.cs
{
    class Program
    {
        ...
        static async Task<Option<Image>> DownloadOptionImage2(string blobReference)
        {
            try
            {
                CloudStorageAccount storageAccount = CloudStorageAccount.Parse("<DefaultEndpointsProtocol=https;AccountName=zhanbatyr;AccountKey=ydqMQB0KFpy1XUvQxC8yz28APXEnBOfLNf6lMq6xrIT9INASIPS/57MmeNMyUs8bTiEu9rqwusNn+AStPn4FSQ==;EndpointSuffix=core.windows.net>");
